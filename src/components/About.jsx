    ...
    <div className="absolute w-full p-[2rem] text-[#F0F0F0]  bg-[#101010] z-[2] top-0 left-0 right-0">
      ...
      <div className="flex flex-col lg:flex-row items-start justify-between">
        <div className=" rounded-full lg:rounded-md mr-14  ml-16 p-2 border-solid border-2   border-[rgba(0,0,0,.2)]">
          <img
            src="/martin.jpeg"
            className=" md:w-[100vw]   lg:rounded-sm rounded-full lg:h-[80vh]"
            alt="img1"
          />
        </div>
        <div className="flex pr-2 md:pr-[2.9rem] pt-6 flex-col gap-4  md:items-start md:justify-start items-center  ">
          <h2 className="text-[#038759] font-bold text-2xl tracking-wide">
            Who am i?
          </h2>
          <h1 className="font-extrabold   text-2xl  leading-10 tracking-wide md:text-start text-center">
            I&#39;m Martin Ogbemudia, a Frontend Developer
          </h1>
          <p className="text-[#969696] text-[1rem] leading-8 md:text-start text-center">
            I am a frontend developer based in Nigeria with a year of
            experience. Throughout my experience, I&#39;ve specialized in
            building robust websites and applications. My approach emphasizes
            staying updated with current industry trends to deliver efficient
          ...
          <div className=" flex-col md:flex  md:flex-row  text-[.9rem]  md:gap-[2rem] lg:gap-[7rem] pt-4">
            <div className="flex flex-col pb-2 gap-[1rem]">
              <div className="">
                Name:{" "}
                <span className="text-[#969696] tracking-wide pl-2">
                  Martin Ogbemudia
                </span>
              </div>
              <div className="">
                Age:{" "}
                <span className="text-[#969696] tracking-wide pl-2">18</span>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-[1rem]">
              <div className="">
                Email:{" "}
                <a
                  className="text-[#038759] tracking-wide pl-2"
                  href="mailto:martindev52@gmail.com?subject=Inquiry from Potential Client"
                  target="_blank"
                >
                  martindev52@gmail.com
                </a>
              </div>
              <div className="">
                From:{" "}
          ...
          <div className="flex-col md:flex md:flex-row text-start pt-4 gap-4">
            <div className="">
              <button className=" tracking-wide rounded-full py-2 px-6 bg-[#038759]">
                <a href="/Resume.pdf" download="Martin_CV.pdf">
                  Download CV
                </a>
              </button>
            </div>
            ...
            <div className="flex text-xl items-center justify-center pt-[1rem] md:pt-0  gap-4 text-[#969696]">
              <a
                href="https://www.linkedin.com/in/ogbemudia-martin-4a8226235/"
                target="_blank"
              >
                <FaLinkedin />
              </a>
              ...
              <a href="https://github.com/ogbemudiamartin" target="_blank">
                <FaGithub />
              </a>
            </div>
          </div>
      ...
      <div className=" px-2 lg:px-16 md:px-[0.8rem] pt-[7rem] tracking-wide">
        ...
        <div className=" md:flex md:flex-row flex-col items-center justify-center gap-6 pt-[3rem]">
          <div className="flex flex-col hover:border-b-2 hover:border-solid  hover:border-[#038759] items-start shadow-md rounded-sm justify-center mb-6 md:mb-0  p-9 gap-3 bg-[#161616]">
            ...
            <p className="text-[#636363] leading-7">
              Creating custom websites that reflect your unique business vision
            </p>
          </div>
          ...
          <div className="flex flex-col hover:border-b-2 hover:border-solid  hover:border-[#038759] items-start shadow-md rounded-sm justify-center  mb-6 md:mb-0  p-9 gap-3 bg-[#161616]">
            ...
            <p className="text-[#636363] leading-7 ">
              Crafting sleek interfaces with Html, Css, JavaScript
            </p>
          </div>
          ...
          <div className="flex flex-col hover:border-b-2 hover:border-solid  hover:border-[#038759] items-start shadow-md rounded-sm justify-center  mb-6 md:mb-0  p-9 gap-3 bg-[#161616]">
            ...
            <p className="text-[#636363] leading-7">
              Delivering seamless, fully responsive experiences across all
              devices
            </p>
          </div>
        </div>
