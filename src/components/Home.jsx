    ...
    <div className="absolute w-full top-0 left-0 right-0">
      ...
      <header className="md:px-[4rem]  px-[1.8rem] w-full h-[100vh]  py-8 bg-[rgb(0,0,0,.8)] text-[#fff]">
        ...
        <div className="flex justify-between items-center">
          <img
            src="/logo.png"
            className="object-cover md:w-[9vw] w-[15vw] h-full cursor-pointer"
            alt="logo"
          />
          {/* Navbar */}
          ...
          <nav className="flex items-center  justify-between  ">
            <div className="md:flex items-center hidden justify-center no-underline  gap-8 text-white">
              <Link to="/about" className="p-2 px-2 group">
                About
                <div className="bg-gray-400 h-[2px] w-0 group-hover:w-full transition-all duration-500"></div>
              </Link>
              <Link to="/Resume" className="p-2 px-2 group">
                Resume
                <div className="bg-gray-400 h-[2px] w-0 group-hover:w-full transition-all duration-500"></div>
              </Link>
              <Link to="/portfolio" className="p-2 px-2 group">
                Portfolio
                <div className="bg-gray-400 h-[2px] w-0 group-hover:w-full transition-all duration-500"></div>
              </Link>
              <Link to="/contact" className="p-2 px-2 group">
                Contact
                <div className="bg-gray-400 h-[2px] w-0 group-hover:w-full transition-all duration-500"></div>
              </Link>
            </div>
          ...
          {isOPen && (
            <nav className="flex md:hidden  absolute   top-[5rem]  right-[2rem] p-4 w-[39vw] md:w-[34vw] lg:w-[28vw]    bg-[#192324] items-start justify-start  ">
              <div
                className="flex flex-col   items-start justify-center flex-wrap
            no-underline  gap-6 text-white  "
              >
                <Link to="/about" className="pr-[3rem]">
                  About
                </Link>
                <Link to="/Resume" className="pr-[3rem]">
                  Resume
                </Link>
                <Link to="/portfolio" className="pr-[3rem]">
                  Portfolio
                </Link>
                <Link to="/contact" className="pr-[3rem]">
                  Contact
                </Link>
              </div>
            </nav>
        ...
        <div className="lg:pt-[10rem] pt-[18rem] text-[#fff]">
          <div className="flex flex-col items-center justify-center gap-4">
            <div className="lg:text-[4rem]  md:text-[3rem] font-bold tracking-wide text-[1.8rem]">
              Martin Ogbemudia
            </div>
            <div className="md:text-[2rem] text-[1.3rem] tracking-wide flex items-center justify-center gap-2">
              I’m a{" "}
              <span>
                <Typewriter
                  options={{
